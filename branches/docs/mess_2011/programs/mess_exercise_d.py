# XXX STEP 4
# modify program of part c) to also fetch coordinates for station RJOB via arclink from WebDC
# use program of part b) and use event coordinates to dynamically determine the hypocentral distance
# use function utlGeoKm in module obspy.signal to calculate distances from coordinates
